...
var line = d3.svg.line()
    ...
    .y(function(d) { return y(d.marketCapitalization); });
...
var area = d3.svg.area()
    .interpolate("basis")
    .x(function(d) { return x(d.year); })
    .y1(function(d) { return y(d.marketCapitalization); });
...
data = JSON.parse(csvData);
  ...
  companyName.forEach(function(s) {
    // s.values.forEach(function(d) { d.date = parse(d.year); d.price = +d.market; });
    s.maxPrice = d3.max(s.values, function(d) { return d.marketCapitalization; });
    s.sumPrice = d3.sum(s.values, function(d) { return d.marketCapitalization; });
  });

  // Sort by maximum price, descending.
  companyName.sort(function(a, b) { return b.maxPrice - a.maxPrice; });
...
//   var g = svg.selectAll(".consituents")
